...
struct Electrolyzer <: EMB.Network
    ...
    Output::Dict{EMB.Resource, Real} # Map of output resources to characteristic flow. The electrolyzer efficiency is captured in one of the values in "Input" or "Output"
